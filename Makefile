...
CXXFLAGS += -Iinclude/vnxvideo -I$(FFMPEG_HOME)/include -I$(IPP_HOME)/include -I$(OPENH264_HOME)/include -DVNXVIDEO_EXPORTS -fPIC

LDFLAGS += -L$(FFMPEG_HOME)/lib -L$(OPENH264_HOME)/lib -L$(IPP_HOME)/lib/intel64

LDLIBS = -l:libopenh264.a -lavcodec -lavutil -lswscale $(IPPLIBS) -lpthread -lz -ldl -lrt -lswresample -l:libboost_system.a
